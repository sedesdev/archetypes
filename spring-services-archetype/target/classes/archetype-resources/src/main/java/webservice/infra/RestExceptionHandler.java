...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.webservice.infra;
...
import ${groupId}.base.infra.spring.webservice.exception.RestException;
import ${groupId}.base.infra.spring.webservice.info.ErroInfo;
